    ...
    \begin{columns}
        \begin{column}{0.5\linewidth}
            \begin{tikzpicture}[ampersand replacement=\&]
                ...
                \draw[-Stealth] (m-5-1.south) to [bend right, out=-90, in=-90, looseness=2] node [below] {$\widehat{f}_1$} (m-5-2.south west);
                \draw[-Stealth] (m-5-2.south) to [bend right, out=-90, in=-90, looseness=2] node [below] {$\widehat{f}_2$} (m-5-3.south west);
                \draw[-Stealth] (m-5-3.south) to [bend right, out=-90, in=-90, looseness=2] node [below] {$\widehat{f}_3$} (m-5-4.south west);
                \draw[-Stealth] (m-5-4.south) to [bend right, out=-90, in=-90, looseness=2] node [below] {$\widehat{f}_4$} (m-5-5.south west);
            \end{tikzpicture}
        \end{column}
        \begin{column}{0.5\linewidth}
