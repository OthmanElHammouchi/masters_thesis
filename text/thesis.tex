...
%   \begin{figure}
%     \centering
%     \includegraphics{glm_sim_densities_1}
...
%     \captionsetup{list=off,format=cont}
%     \centering
%     \includegraphics{glm_sim_densities_2}
%     \caption{ODP model simulation results for the semiparametric bootstrap, $c_\mu = c_\sigma = 0.75$}
%   \end{figure}
% \end{landscape}
...
\begin{landscape}
  \begin{figure}
    \centering
    \includegraphics{glm_sim_densities_parametric_normal_1}
...
\begin{landscape}
  \begin{figure}
    ...
    \captionsetup{list=off,format=cont}
    \centering
    \includegraphics{glm_sim_densities_parametric_normal_2}
    \caption{ODP model simulation results for the parametric bootstrap with normal, $c_\mu = c_\sigma = 0.75$}
  \end{figure}
\end{landscape}
...
\begin{landscape}
  \begin{figure}
    \centering
    \includegraphics{glm_sim_densities_parametric_poisson_1}
...
\begin{landscape}
  \begin{figure}
    ...
    \captionsetup{list=off,format=cont}
    \centering
    \includegraphics{glm_sim_densities_parametric_poisson_2}
    \caption{ODP model simulation results for the parametric bootstrap with Poisson, $c_\mu = c_\sigma = 0.75$}
  \end{figure}
\end{landscape}
