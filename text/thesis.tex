...
\begin{table}[!htb]
  ...
  \begin{subtable}{0.5\linewidth}
    ...
    \subcaption{Unconditional}
  \end{subtable}
  \caption{Results of the parametric bootstrap with the normal distribution for the data from \cref{tab:uk-motor}}
...
\begin{table}[!htb]
  ...
  \begin{subtable}{0.5\linewidth}
    ...
    \subcaption{Unconditional}
  \end{subtable}
  \caption{Results of the parametric bootstrap with the gamma distribution for the data from \cref{tab:uk-motor}}
