...
% residuals cond studentised
\begin{landscape}
  \begin{figure}
    \centering
    \includegraphics{mack_sim_densities_cond_residuals_studentised_1}
...
\begin{landscape}
  \begin{figure}
    ...
    \captionsetup{list=off,format=cont}
    \centering
    \includegraphics{mack_sim_densities_cond_residuals_studentised_2}
    \caption{Mack model simulation results for the conditional semiparametric bootstrap with studentised residuals}
    \label{fig:sim-res}
  \end{figure}
\end{landscape}
